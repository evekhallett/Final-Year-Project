...
def main():
    ...
    #MAKE COLUMNS NAMES CORRESPONDING TO CODON POSITION
    ...
    df = df.astype(int)
    #MAKE CSV
    df.to_csv('/Users/evehallett/Documents/dissertation/to_submit/Figure2/ecoli_gc2_40.csv', index=False)
    print(df)
